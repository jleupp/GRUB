...
SHOW WARNINGS;
CREATE INDEX `customer_id_idx` ON `address` (`email` ASC);
...
START TRANSACTION;
USE `gitgrubdb`;
INSERT INTO `restaurant` (`id`, `category_id`, `name`, `open_time`, `close_time`, `street_address`, `city`, `state`, `zipcode`, `phone`, `manager_email`, `table_count`) VALUES (1, 'JAPANESE', 'Tokyo Joes', '100000', '220000', '6380 S Fiddlers Green Cir', 'Greenwood Village', 'CO', '80111', '(303)220-2877', 'tokyo_joe@mail.com', 30);
INSERT INTO `restaurant` (`id`, `category_id`, `name`, `open_time`, `close_time`, `street_address`, `city`, `state`, `zipcode`, `phone`, `manager_email`, `table_count`) VALUES (2, 'ITALIAN', 'Panzano', '063000', '230000', '909 17th St', 'Denver', 'CO', '80202', '(303)296-3525', 'manager@panzano.com', 12);
INSERT INTO `restaurant` (`id`, `category_id`, `name`, `open_time`, `close_time`, `street_address`, `city`, `state`, `zipcode`, `phone`, `manager_email`, `table_count`) VALUES (3, 'AMERICAN(NEW)', 'The SportsBook Bar and Grill', '110000', '020000', '9660 E Arapahoe Rd', 'Greenwood Village', 'CO', '80112', '(303)799-1300', 'manager@SB.com', 15);
...
START TRANSACTION;
USE `gitgrubdb`;
INSERT INTO `menu` (`menu_id`, `type`, `start_time`, `end_time`, `restaurant_id`) VALUES (1, 'DINNER', '170000', '220000', 1);
INSERT INTO `menu` (`menu_id`, `type`, `start_time`, `end_time`, `restaurant_id`) VALUES (2, 'DINNER', '160000', '230000', 2);
INSERT INTO `menu` (`menu_id`, `type`, `start_time`, `end_time`, `restaurant_id`) VALUES (3, 'BAR', '160000', '230000', 3);
...
START TRANSACTION;
USE `gitgrubdb`;
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('HOME', '2987 Wentworth Way', 'Tarpon Springs', 'FL', '34688', 'maya.mohan@ahtllc.com');
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('DETROIT', '22511 Santa Maria St', 'Santa Maria', 'MI', '48219', 'elijah.molnar@gmail.com');
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('HOME', '2627 W 34th Ave', 'Denver', 'CO', '80211', 'jeffrey.leupp@gmail.com');
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('HOME', '1110 NE Lakewood Dr', 'Newport', 'OR', '97365', 'elijah.molnar@gmail.com');
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('DENVER', '7587 E Technology Dr', 'Denver', 'CO', '80237', 'maya.mohan@ahtllc.com');
INSERT INTO `address` (`address_tag`, `street_address`, `city`, `state`, `zipcode`, `email`) VALUES ('HOME', '2627 W 34th Ave', 'Denver', 'CO', '80211', 'elenapignatelli@gmail.com');
